    ...
    categories: [
      ...
      },
      {
        ...
        tools: [
          ...
          { name: "JavaScript / TypeScript", url: "https://www.typescriptlang.org", desc: "브라우저와 Node.js 환경의 표준 언어. TypeScript는 정적 타입으로 대규모 코드베이스를 관리한다.", tags: ["웹", "Node.js", "프론트엔드"], logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/typescript/typescript-original.svg" },
    ...
    categories: [
      {
        ...
        tools: [
          ...
          { name: "XGBoost / LightGBM", url: "https://xgboost.readthedocs.io", desc: "Gradient Boosting 기반 고성능 앙상블 알고리즘. 정형 데이터 경진대회와 프로덕션 모델에서 압도적으로 쓰인다.", tags: ["Boosting", "정형 데이터", "고성능"], logo: "" },
      ...
      },
      {
        ...
        tools: [
          ...
          { name: "Grafana", url: "https://grafana.com", desc: "시계열 지표 모니터링 대시보드. Prometheus·InfluxDB 등과 연동해 인프라·ML 모델 성능을 실시간으로 관찰한다.", tags: ["모니터링", "시계열", "오픈소스"], logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/grafana/grafana-original.svg" },
        ]
      },
      {
        name: "MLOps & 실험 관리",
        tools: [
          ...
          { name: "Airflow", url: "https://airflow.apache.org", desc: "Python DAG 기반 워크플로우 오케스트레이터. 데이터 파이프라인·ML 학습 스케줄링에 널리 쓰인다.", tags: ["워크플로우", "스케줄링", "오픈소스"], logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/apacheairflow/apacheairflow-original.svg" },
